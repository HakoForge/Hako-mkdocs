...
![HakoForge CRPS PSU Adapter](../imgs/Front-Angled.webp){: style="max-width: 700px; width: 100%;"}

<div class="hf-photo-album" markdown="1">
![Adapter installed in chassis — front](../imgs/Front-Angled-Attached.webp)
![Adapter with PSU installed — front](../imgs/Front-Angled-PSU.webp)
![Adapter with PSU installed — front, alternate view](../imgs/Front-Angled-PSU2.webp)
![Adapter installed in chassis — rear](../imgs/Rear-Angled-Attached.webp)
![Adapter with PSU installed — rear](../imgs/Rear-Angled-PSU.webp)
</div>
