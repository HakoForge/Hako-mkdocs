...
## Overview
Drive cages provide the mechanical interface between storage devices and the chassis. They ensure proper alignment with backplane drive connectors.

The chassis supports multiple cages to accommodate different storage configurations. Each cage is designed for specific drive formats and mounting requirements.
...
![Cage Installation Overview](../../hf-l1/imgs/CageInstall.png)
...
For how to remove the lid see [Top Panel Removal](../../hf-l1/hardware/panel-removal.md)
